      ...
      <nav class="mt-2">
        ...
        {{-- end attendent--}}
          ...
          <li class="nav-item {{ request()->is('admin/users*') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ admin_url('peoples/users') }}" class="nav-link {{ request()->is('admin/users') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>{{__('admin.user_lists')}}</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ admin_url('peoples/users/create') }}" class="nav-link {{ request()->is('admin/users/create') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>{{__('admin.add_user')}}</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ admin_url('peoples/students') }}" class="nav-link {{ request()->is('admin/students') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>{{__('admin.student_lists')}}</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ admin_url('peoples/students/create') }}" class="nav-link {{ request()->is('admin/students/create') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
